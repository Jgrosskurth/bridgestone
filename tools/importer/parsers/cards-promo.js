 ...
 * Extracts promotional cards from bsx-section#offers bsx-card-base JSON.
 * Cards block: each row = 1 card. Col 1 = image, Col 2 = header + dates + details + CTA.
...
export default function parse(element, { document }) {
  ...
  items.forEach(({ json }) => {
    ...
    // Col 2: Header title/subheader + content + CTA
